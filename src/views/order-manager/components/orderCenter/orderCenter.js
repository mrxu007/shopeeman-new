 ...
 * @LastEditTime: 2021-11-11 21:29:18
...
const syncStatusAll = [
  ...
  { label: '运送中', value: 'shipping'},
  { label: '已完成', value: 'completed'},
  { label: '取消中', value: 'cancelled'},
...
const syncStatus = [
  ...
  // { label: '运送中', value: 'shipping'},
  { label: '已完成', value: 'completed'},
  // { label: '取消中', value: 'cancelled'}, //cancelled  //cancelled_all
  // { label: '退款中', value: 'refund'},
]
