 ...
 * @LastEditTime: 2021-11-10 16:19:22
...
const timeTypeList = [
    { value: 'timeType', label: '订单支付时间' },
    { value: 'shopeeDeliveryTime', label: '发货时间' },
    { value: 'sourceShippingTime', label: '采购发货时间' },
    { value: 'shipByDate', label: '订单截止发货时间' }
]
...
const inputTypeList = [
    ...
    { value: 'originalTrackingNumber', label: '采购物流单号' },
    { value: 'patOrderSn', label: '采购单号' },
    { value: 'trackingNo', label: '平台物流单号' },
    { value: 'remark', label: '备注' },
    { value: 'variationSku', label: '商品货号' },
    { value: 'buyAccount', label: '买手号' },
    { value: 'payAccount', label: '支付账号' }
]
...
const site_mall = {
  ...
  function siteShip(country){
    return site_mall[country] || []
  }


export  { orderStatusList, shotStatusList, timeTypeList, inputTypeList, goodsSourceList, siteShip}