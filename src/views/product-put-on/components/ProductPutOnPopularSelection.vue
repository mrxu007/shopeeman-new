<template>
  <div class="product-put-on-popular-selection">
    <div class="category-choose-box">
      ...
      <div class="conditions-box">
        <span>排行：</span>
        <el-select v-model="sortBy" placeholder=""  size="mini" filterable>
    ...
    <div class="content">
      <el-table v-loading="tableLoading" ref="multipleTable" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column width="120px" label="商品图片" prop="country" align="center">
          <template slot-scope="scope">
            <el-image v-bind:src="[scope.row.platform , scope.row.shopid , scope.row.image ]| imageRender"></el-image>
          </template>
        </el-table-column>
        <el-table-column width="120px" label="商品名称" prop="country" align="center">
          <template slot-scope="scope">{{ scope.row.name  }}</template>
        </el-table-column>
        <el-table-column width="120px" label="官方店铺" prop="country" align="center">
        ...
        <el-table-column min-width="60px" label="价格" prop="warehouse_name" align="center">
